...
This means inside a header file you need to put your custom code between
`#ifndef INC_02_BACKGROUND_TASKS_H_
#define INC_02_BACKGROUND_TASKS_H_`
and
`#endif /* INC_02_BACKGROUND_TASKS_H_ */`
