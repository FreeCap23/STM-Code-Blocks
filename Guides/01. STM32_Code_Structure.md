...
- a header file contains only a list of variables and functions
- a source file contains also the values of the variables and the code of the functions mentioned in the header file with the same name. To link the content of the source file with the content of the header file, the header file must be included into the source file with the line `#include <headerFileName.h>`
