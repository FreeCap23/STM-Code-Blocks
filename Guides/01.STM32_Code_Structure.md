...
> ℹ️ **Important**: To avoid defining a header file multiple types by mistake (and get compilation errors), a good practice is to always use "header guards" in header files.
